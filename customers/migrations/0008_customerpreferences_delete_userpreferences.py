...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('customers', '0007_alter_userpreferences_budget_range'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget_range', models.FloatField(default=7.0)),
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customer_profile1', to='customers.customer')),
            ],
        ),
